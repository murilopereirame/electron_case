...
const NewSubTaskDialog = () => {
    ...
    return {
        view: (node) => {
            return m(`div.p-4 z-20 shadow-lg shadow-black/50 rounded-xl flex flex-col items-center w-96 bg-charcoal-700`, {"data-test": "new-subtask-dialog-container"}, [
                ...
                m("div.flex justify-end items-center w-full mt-4", [m("button.bg-spring-600 text-white rounded-md p-2 font-bold", {
                    onclick: () => {
